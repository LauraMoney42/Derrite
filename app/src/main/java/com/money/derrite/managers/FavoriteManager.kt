...
class FavoriteManager(
    ...
    fun addFavorite(
        ...
        val favorite = FavoritePlace(
            ...
            enableSafetyAlerts = true // Always true
        )
    ...
    fun createFavoriteFromLocation(
        ...
        name: String,
        description: String,
        categories: Set<com.money.derrite.data.ReportCategory>, // Keep parameter for compatibility but ignore
    ...
    private fun convertFavoritesToJson(favorites: List<FavoritePlace>): String {
        return favorites.joinToString("|||") { favorite ->
            "${favorite.id}:::${favorite.name}:::${favorite.location.latitude}:::${favorite.location.longitude}:::${favorite.alertDistance}:::${favorite.enableSafetyAlerts}:::${favorite.createdAt}:::${favorite.description}"
        }
    }
}