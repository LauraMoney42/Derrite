...
import com.money.derrite.managers.FavoriteManager
import com.money.derrite.managers.PreferencesManager
import com.money.derrite.managers.ReportManager
import com.money.derrite.managers.LocationManager
import androidx.appcompat.app.AlertDialog
import com.money.derrite.managers.DialogManager
...
class FavoritesActivity : AppCompatActivity(), FavoriteManager.FavoriteListener {
    ...
    private fun setupUI() {
        ...
        val faqLink = TextView(this).apply {
            ...
            setOnClickListener {
                // Show FAQ dialog
                val dialogManager = com.money.derrite.managers.DialogManager(this@FavoritesActivity, preferencesManager)
